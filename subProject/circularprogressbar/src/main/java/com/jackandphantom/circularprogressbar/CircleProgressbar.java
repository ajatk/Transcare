...
public class CircleProgressbar extends View {
    ...
    */
    private final int DEFAULT_FOREGROUND_PROGRESS_WIDTH = 6;
    private final int DEFAULT_BACKGROUND_CIRCLE_WIDTH = 6;
     ...
     */
    private int DEFAULT_BACKGROUND_PROGRESS_COLOR = Color.RED;
